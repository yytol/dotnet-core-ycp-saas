    ...
    show: function (entrance, url, opt, fn) {
        ...
        var process = function () {
            ...
            if (!dpz.isNull(opt)) {
                ...
                if (typeof opt.toTop !== "undefined") cfg.toTop = opt.toTop;
            ...
            //设置样式
            $("#dpz_Desktop_Dialog_Box").attr("style", "");
            ...
            if (cfg.hasBackground) {
                $("#dpz_Desktop_Dialog_Area").css({ backgroundColor: "" });
            } else {
                $("#dpz_Desktop_Dialog_Area").css({ backgroundColor: "rgba(0,0,0,0)" });
            }

            var animateMarginTop = "";
            if (cfg.toTop) {
                $("#dpz_Desktop_Dialog_Box").css({ top: "0px", maxHeight: "calc(100% - 30px)" });
                animateMarginTop: "0px";
            } else {
                $("#dpz_Desktop_Dialog_Box").css({ top: "50%", maxHeight: "" });
        ...
        $("#dpz_Desktop_Info").css({ opacity: 0, bottom: "0px", display: "block" }).animate({ opacity: 1, bottom: "50px" }, 300, function () {
            ...
            ycc.sendJttp("User.GetInfo", {}, function (e) {
                ...
                if (status > 0) {
                    ...
                    desktop.dialog.show(ycc.desktopConfig.UrlEntrance, "/res/Desktop/Login/config.json", cfg, desktop.wait.hide);
                }
            });
